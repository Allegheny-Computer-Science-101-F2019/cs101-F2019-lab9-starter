...
one of the student technical leaders if you have questions about any of these
reading assignments.
...
- The ArrayList.java in src/main/java/labnine/list has exactly 0 of the `Add Your Name Here` fragment
- The ArrayList.java in src/main/java/labnine/list has exactly 0 of the `TODO` fragment
- The ArrayList.java in src/main/java/labnine/list has exactly 0 of the `public abstract class` fragment
- The ArrayList.java in src/main/java/labnine/list has exactly 1 of the `package labnine` fragment
- The ArrayList.java in src/main/java/labnine/list has exactly 1 of the `private class ArrayIterator` fragment
- The ArrayList.java in src/main/java/labnine/list has exactly 1 of the `public String toString(` fragment
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command `gradle test` executes correctly
- The command output has exactly 2 of the `removing first element` fragment
- The command output has exactly 6 lines
- The file ArrayList.java exists in the src/main/java/labnine/list directory
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 20/20 (100%) of checks for cs101-F2019-lab9! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2019/cs101-F2019-lab9-starter.git
```
...
9](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab9-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-101-F2019/cs101-F2019-lab9-starter/issues).
